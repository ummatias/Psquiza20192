...
/**
 * Classe que modela um item de uma ativade, podendo ser descrito como
...
public class Item implements Serializable{
	...
	/**
	 * Cria uma representação em String de um item, no padrão "Estado_do_item -
	 * descrição_do_item"
	 */
